...
* maxNums and the smallest numbers are allocated to minMax. This split
...
class MinMax{
    ...
    private void split(int[] numbers, int[] maxNums, int[] minNums) {
...
//        System.out.println(avg);
        ...
        if(test) {
          ...
          if (minMaxAverage(new int[]{40, 49, 64, 3, 45, 69, 24, 36, 31, 62, 3, 8, 9, 54, 78}) != 40.5)
          ...
          if (minMaxAverage(new int[]{12, 93, 4, 76, 85, 8, 53, 10, 73, 5, 30, 75, 1, 67, 28, 25}) != 47.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{31, 76, 30, 76, 86, 73, 92, 18, 36, 84, 85, 22, 39, 9, 26, 16, 25, 85, 67}) != 50.5)
              throw new AssertionError();
          ...
          if (minMaxAverage(new int[]{91, 96, 86, 38, 73, 9, 77, 28, 77, 13, 18, 85, 25, 73, 91, 14}) != 52.5)
              throw new AssertionError();
          ...
          if (minMaxAverage(new int[]{52, 98, 90, 64, 86, 24, 83, 67, 100, 7, 87, 93}) != 53.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{74, 15, 42, 37, 34, 50, 47, 38, 41, 42, 70, 53, 96, 6, 96, 58, 85, 19}) != 51.0)
              throw new AssertionError();
          ...
          if (minMaxAverage(new int[]{30, 51, 91, 12, 68, 38, 97, 97, 62, 56, 93, 46, 22, 84}) != 54.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{73, 59, 8, 30, 93, 50, 48, 42, 73, 25}) != 50.5) throw new AssertionError();
          if (minMaxAverage(new int[]{65, 71, 23, 78, 44, 47, 20, 47, 59, 29, 39, 80, 38, 58, 26, 27, 59}) != 50.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{81, 51, 41, 24, 11, 23, 94, 1, 3, 98, 55, 69, 47}) != 49.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{60, 13, 90, 75, 90, 21, 79, 8, 62, 96, 9, 56}) != 52.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{52, 25, 35}) != 38.5) throw new AssertionError();
          if (minMaxAverage(new int[]{90}) != 90.0) throw new AssertionError();
          if (minMaxAverage(new int[]{34, 93, 80, 90, 35, 97, 44, 87, 86, 83, 92, 18, 81, 75}) != 57.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{93, 64, 42, 33, 15, 45, 99, 29, 74, 23, 46, 19, 9, 89, 46}) != 54.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{82, 52, 79, 31, 60, 97, 5, 29, 39, 87, 80, 27, 17, 7, 88, 67, 34, 82, 86}) != 51.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{18, 20, 56, 27, 44, 13, 25, 40, 33, 91, 71, 16, 100, 15}) != 56.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{74, 59, 32, 4, 18, 18, 90}) != 47.0) throw new AssertionError();
          if (minMaxAverage(new int[]{36, 71, 58, 72, 57, 75, 4, 15, 85, 80, 34, 92, 67, 57, 44, 22, 61}) != 48.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{20, 33, 31, 31, 76, 26, 89, 25, 52, 58, 69, 60}) != 54.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{79, 45, 58}) != 62.0) throw new AssertionError();
          if (minMaxAverage(new int[]{80, 24, 23, 49, 11, 85, 55, 16, 72, 85, 4, 50, 94, 73, 34, 27, 56, 70, 68, 34}) != 49.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{52, 76, 74, 95, 5, 44, 98, 89, 6, 91, 94, 98, 51, 23, 54, 19, 67, 60}) != 51.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{90, 92, 44, 13, 14, 67}) != 52.5) throw new AssertionError();
          if (minMaxAverage(new int[]{63, 90, 50, 27, 5, 85, 19, 68, 58, 93, 63, 93, 74, 53, 92, 84, 72}) != 49.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{99, 53, 99, 61, 7, 44, 54, 52, 74, 95, 78, 33, 45, 15, 29, 44}) != 53.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{42, 20, 66, 100, 9, 21, 58, 26, 53, 48, 56, 76, 47, 26, 56, 50}) != 54.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{90, 39, 29, 12, 69, 63, 43}) != 51.0) throw new AssertionError();
          if (minMaxAverage(new int[]{25, 44, 25, 53, 72, 78, 52, 14, 56, 74, 56, 16, 80, 1, 65, 50, 81}) != 41.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{35, 16, 48, 22, 67, 79, 67, 81, 46, 80, 4, 62, 56, 58, 49, 88, 2, 2}) != 45.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{63, 21, 22, 63, 23, 56, 44, 75, 92, 95, 23, 33, 55, 33, 23, 2, 47}) != 48.5)
              throw new AssertionError();
          ...
          if (minMaxAverage(new int[]{3, 56, 14, 50, 47, 98, 83, 76, 17, 79, 39, 60}) != 50.5)
              throw new AssertionError();
          ...
          if (minMaxAverage(new int[]{41, 73, 74, 92, 74, 2, 95, 89, 1, 82, 53, 81}) != 48.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{14, 11, 18}) != 14.5) throw new AssertionError();
          if (minMaxAverage(new int[]{98, 28, 24, 28, 53, 49, 98, 61, 76, 76, 30, 72, 19, 66}) != 58.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{37, 57, 3, 54, 20, 86, 41, 46, 6, 83, 30, 41, 86, 56, 79, 63, 47}) != 44.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{23, 23, 24, 66, 71, 53, 85, 59, 29, 4, 42}) != 44.5) throw new AssertionError();
          if (minMaxAverage(new int[]{67, 98, 17, 95, 49, 83, 84, 38, 15, 65, 56, 46, 86, 32, 26, 80}) != 56.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{84, 24, 53, 34, 55, 13, 5, 70, 1, 32, 16, 80, 65, 53}) != 42.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{85, 33, 86, 19, 81, 97, 62, 60, 84, 37, 83, 81, 89, 67}) != 58.0)
              throw new AssertionError();
          ...
          if (minMaxAverage(new int[]{49, 56, 25, 11, 41, 31, 14, 53, 24, 53, 94, 65, 24, 30, 36, 35, 47, 64, 32, 32}) != 52.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{75, 29, 24, 2, 67, 21, 4, 6, 23, 71, 90, 19, 59, 28, 40, 87}) != 46.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{15, 88, 58, 60, 3, 9, 2, 82, 51, 60, 65, 85, 100, 52, 13}) != 51.0)
              throw new AssertionError();
          if (minMaxAverage(new int[]{79, 93, 75, 6, 95, 85, 53, 88, 6, 5, 70, 98, 13, 66, 94, 46}) != 51.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{74, 26, 62, 66, 48, 84, 56, 52, 85, 59, 46, 58}) != 55.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{97, 34, 33}) != 65.0) throw new AssertionError();
          if (minMaxAverage(new int[]{19, 85, 12, 91, 51, 12, 90, 61, 55, 5, 56, 100, 64, 89, 87, 93, 66, 89, 36, 38}) != 52.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{4, 89, 51, 15, 35, 54, 73, 79, 93, 83, 18, 43, 34, 58, 73}) != 48.5)
              throw new AssertionError();
          if (minMaxAverage(new int[]{12, 45, 14, 87, 83, 16, 86, 22, 97, 11, 26, 37, 61, 18, 51}) != 54.0)
              throw new AssertionError();
          ...
          if (minMaxAverage(new int[]{23, 49, 9, 2, 33, 30, 40, 100, 14, 1, 21, 89}) != 50.5)
              throw new AssertionError();
          ...
          if (minMaxAverage(new int[]{72, 22, 44, 56, 42, 43, 18, 50, 31, 6, 13, 31, 47, 16, 69, 4, 2, 24, 19}) != 37.0)
              throw new AssertionError();
          ...
          if (minMaxAverage(new int[]{4, 73, 37, 31, 92, 53, 36, 95, 55, 55, 78, 43}) != 49.5)
              throw new AssertionError();
          ...
          if (minMaxAverage(new int[]{5, 96, 38, 76, 43, 51, 30, 44, 5, 98, 54, 95, 39, 53, 91, 90}) != 51.5)
              throw new AssertionError();
